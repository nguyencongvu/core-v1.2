var modelName = 'issue'; //--edit here movie to user modelName = viewName
var routePath = '/issues';  //--edit here -- routePath+'/:id'
...
function searchMiddle(req, res, next){
    ...
    if (    
            !searchValue &&
            !inString(urlPath,"issues/report") &&
            !inString(urlPath,"issues/excel") && 
            !inString(urlPath,"issues/json") &&
            !inString(urlPath,"issues/jsonmap")
        )
    { 
    ...
    if (searchValue){
        ...
        conditions = { 
            $or: [ 
                ...
                { "issue.reason": reg },      //-- EDIT
                { "issue.description": reg },      //-- EDIT
                { "issue.fix": reg }      //-- EDIT
            ], 
        };     
    }
