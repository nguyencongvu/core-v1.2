var modelName = 'list'; //--edit here movie to user modelName = viewName
var routePath = '/admin/lists';  //--edit here -- routePath+'/:id'
...
function searchMiddle(req, res, next){
    ...
    if (    
            !searchValue &&
            !inString(urlPath,"lists/report") &&
            !inString(urlPath,"lists/excel") && 
            !inString(urlPath,"lists/json") &&
            !inString(urlPath,"lists/import") &&
            !inString(urlPath,"lists/jsonmap")
        )
    { 
...
router.post(routePath+'/:id/inlineEdit', isCreatorOrAdmin, function(req,res){
